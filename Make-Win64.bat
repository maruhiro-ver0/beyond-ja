...
echo.
zip BeyondTheTitanic-Win64.zip BEYOND.EXE HELP.TXT HELP.BAT INSTRUCT.TXT INSTRUCT.BAT LINE ROOMS1 ROOMS2 SPECIAL1 SPECIAL2 LICENSE FILE_ID.DIZ FUNCORP.TXT
